...
**DURING BUILD IF ERROR (C1060): COMPLIER IS OUT OF HEAP SPACE YOU CAN USE**
**--local_ram_resources**
**example: bazel build --local_ram_resources=HOST_RAM*.50 --config=opt tensorflow:tensorflow.lib**
## NOTE:
